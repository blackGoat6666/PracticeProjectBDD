...
public class VentanaEmpleadoImpl extends JFrame implements VentanaEmpleado {
	...
	{ 
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(VentanaEmpleadoImpl.class.getResource("/icono/pngtree-aeroplane-icon-design-vector-png-image_1609048.jpg")));
		...
		panelInterno.setBackground(new Color(153, 153, 204));
	...
	private JMenuBar crearMenuOpciones() {
		...
		barraDeMenu.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 10));
		barraDeMenu.setBackground(new Color(153, 153, 204));
	...
	private JPanel crearPanelBotoneraVolverMenuPrincipal() {
		...
		panelBotonera.setBackground(new Color(153, 102, 153));
	...
	private Component crearPanelVuelosDisponibles() {
		...
		panelPpal.setBackground(new Color(153, 153, 204));
	...
	private Component crearPanelReservaIdaVuelta() {
		...
		this.lblVueloSeleccionIda.setBounds(90, 15, 435, 112);
		...
		this.lblDetalleSeleccionIda.setBounds(90, 170, 378, 97);		
